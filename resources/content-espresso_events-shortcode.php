...
<?php if ( is_single() ) : ?>
	...
	<div class="espresso-event-wrapper-dv">
		<?php do_action( 'AHEE_event_details_left_tile', $post ); ?>
		<?php the_content(); ?>
...
<div class="mb-md-5 row no-gutters-md d-flex justify-content-center">

		<?php do_action( 'AHEE_event_details_left_tile', $post ); ?>

  <div class="mt-2 event-content-container pl-md-3 pr-md-3 pr-lg-5"><div>
	<div id="espresso-event-list-header-dv-<?php echo $post->ID;?>" class="espresso-event-header-dv">
		<?php espresso_get_template_part( 'content', 'espresso_events-header' ); ?>
	</div>
	<div class="mb-4 mb-md-0 espresso-event-list-wrapper-dv">
