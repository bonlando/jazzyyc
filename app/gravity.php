...
class GW_Inventory {
	...
	public function parse_args( $args ) {
		...
		$args = wp_parse_args( $args, array(
			...
			'input_id'                 => false,
			'stock_qty'                => false,
			'out_of_stock_message'     => __( 'Sorry, this mask is out of stock.' ),
			'not_enough_stock_message' => __( 'You ordered %1$s of these masks, but there are only %2$s of this mask left.' ),
