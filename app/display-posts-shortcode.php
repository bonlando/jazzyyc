...
function be_dps_survey_admin_notice() {
	...
	?>
		<div class="notice notice-info is-dismissible display-posts-survey-notice">
			...
			<p><?php esc_html_e( 'In 2019 I\'ll be working on new features, including the possibility of a Privilège version. As a valued Display Posts user, your feedback is important and appreciated!', 'display-posts' ); ?></p>
